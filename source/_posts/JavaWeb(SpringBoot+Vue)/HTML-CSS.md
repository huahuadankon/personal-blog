...
![image-20230309163858689](../../assets/JavaWeb(SpringBootVue)/image-20230309163858689-1729574785840-140.png)  
...
<img src="../../assets/JavaWeb(SpringBootVue)/image-20230309170412197-1729574785840-142.png" alt="image-20230309170412197" style="zoom:67%;" /> 
...
>
> - 标记语言：由标签构成的语言
>   - HTML标签都是预定义好的。例如：使用 &LT;h1&gt; 标签展示标题，使用&LT;a&gt;展示超链接，使用&LT;img&gt;展示图片，&LT;video&gt;展示视频。
>   - HTML代码直接在浏览器中运行，HTML标签由浏览器解析。

下面展示的是一段html代码经过浏览器解析，呈现的效果如右图所示：

<img src="../../assets/JavaWeb(SpringBootVue)/image-20230309172534138-1729574785840-141.png" alt="image-20230309172534138" style="zoom:80%;" />   
...
<img src="../../assets/JavaWeb(SpringBootVue)/image-20230309172634388-1729574785840-144.png" alt="image-20230309172634388" style="zoom: 80%;" /> 
...
![1668011569718](../../assets/JavaWeb(SpringBootVue)/1668011569718-1729574785840-143.png) 



第二步：创建一个文本文件，然后修改文件名为hello.html,注意文件的后缀是.html,如下图所示：

![1668012052140](../../assets/JavaWeb(SpringBootVue)/1668012052140-1729574785840-145.png) 
...
<img src="../../assets/JavaWeb(SpringBootVue)/image-20230309173355794-1729574785840-146.png" alt="image-20230309173355794" style="zoom:67%;" />  
...
![image-20230309221756293](D:/Notes/Java/Javaweb/web/课件/day01-HTML-CSS/day01-HTML-CSS/讲义/assets/image-20230309221756293.png)
...
![image-20230309222608750](../../assets/JavaWeb(SpringBootVue)/image-20230309222608750-1729574785840-148.png) 
...
<img src="../../assets/JavaWeb(SpringBootVue)/image-20230309223020809-1729574785840-150.png" alt="image-20230309223020809" style="zoom:67%;" /> 
...
![image-20230309224226495](../../assets/JavaWeb(SpringBootVue)/image-20230309224226495-1729574785840-149.png) 

3). 在VsCode中创建一个新的 html 文件，文件的后缀名设置为 .html

![image-20230309224401950](../../assets/JavaWeb(SpringBootVue)/image-20230309224401950-1729574785840-151.png) 

4). html 文件创建好之后，在其中输入 ！，然后直接回车，就可以生成 HTML 的基础结构标签

![image-20230309224645231](../../assets/JavaWeb(SpringBootVue)/image-20230309224645231-1729574785841-152.png) 
...
![a](D:/Notes/Java/Javaweb/web/课件/day01-HTML-CSS/day01-HTML-CSS/讲义/assets/a.gif)
...
![image-20230309233408698](../../assets/JavaWeb(SpringBootVue)/image-20230309233408698-1729574785841-154.png) 
...
<img src="../../assets/JavaWeb(SpringBootVue)/image-20230310084859695-1729574785841-155.png" alt="image-20230310084859695" style="zoom:80%;" /> 
...
![image-20230310092442972](../../assets/JavaWeb(SpringBootVue)/image-20230310092442972-1729574785841-156.png) 
...
<img src="../../assets/JavaWeb(SpringBootVue)/image-20230310092820616-1729574785841-157.png" alt="image-20230310092820616" style="zoom:80%;" /> 

CSS盒子模型，其实和日常生活中的包装盒是非常类似的，就比如：

<img src="../../assets/JavaWeb(SpringBootVue)/image-20230310093247265-1729574785841-158.png" alt="image-20230310093247265" style="zoom:80%;" /> 
...
![image-20230310093734941](../../assets/JavaWeb(SpringBootVue)/image-20230310093734941-1729574785841-159.png)  



2). span一行会显示多个，用来组合行内元素，默认宽度为内容撑开的宽度

![image-20230310093827748](../../assets/JavaWeb(SpringBootVue)/image-20230310093827748-1729574785841-160.png) 
...
![image-20230310094312355](../../assets/JavaWeb(SpringBootVue)/image-20230310094312355-1729574785841-161.png) 



我们也可以，通过浏览器的开发者工具，清晰的看到这个盒子，以及每一个部分的大小：

![image-20230310094412539](../../assets/JavaWeb(SpringBootVue)/image-20230310094412539-1729574785841-163.png) 
...
![image-20230310094732466](D:/Notes/Java/Javaweb/web/课件/day01-HTML-CSS/day01-HTML-CSS/讲义/assets/image-20230310094732466.png) 
...
![image-20230309174438491](../../assets/JavaWeb(SpringBootVue)/image-20230309174438491-1729574785841-164.png) 
...
![image-20230309175121361](../../assets/JavaWeb(SpringBootVue)/image-20230309175121361-1729574785841-165.png) 
...
<img src="../../assets/JavaWeb(SpringBootVue)/1668055779440-1729574785841-166.png" alt="1668055779440" style="zoom:80%;" /> <img src="D:/Notes/Java/Javaweb/web/课件/day01-HTML-CSS/day01-HTML-CSS/讲义/assets/image-20230309175941128.png" alt="image-20230309175941128" style="zoom:80%;" /> 
...
<img src="../../assets/JavaWeb(SpringBootVue)/image-20230309191725329-1729574785841-168.png" alt="image-20230309191725329" style="zoom:80%;" /> 
...
![image-20230309192625939](../../assets/JavaWeb(SpringBootVue)/image-20230309192625939-1729574785841-169.png) 
...
![image-20230309221308252](../../assets/JavaWeb(SpringBootVue)/image-20230309221308252-1729574785841-170.png) 

而对于input type="hidden"，是一个隐藏域，在表单中并不会显示出来，但是在提交表单的时候，是会提交到服务端的。 接下来，我们就点击提交按钮，来提交当前表单，看看提交的数据：

![image-20230309221530214](../../assets/JavaWeb(SpringBootVue)/image-20230309221530214-1729574785841-171.png) 
...
![html](D:/Notes/Java/Javaweb/web/课件/day01-HTML-CSS/day01-HTML-CSS/讲义/assets/html.gif)
...
![css](D:/Notes/Java/Javaweb/web/课件/day01-HTML-CSS/day01-HTML-CSS/讲义/assets/css.gif) 
