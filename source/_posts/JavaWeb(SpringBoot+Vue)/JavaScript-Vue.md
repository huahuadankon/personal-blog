...
poster:
  topic: 前端开发
  headline: JavaScript-Vue
  caption: 
  color: 标题颜色
sticky: 
author: huahuadan
type: tech
date: 2024-10-22 10:51:29
description: 这是基于黑马程序员的JavaWeb笔记稍作修改
cover:
banner:
mermaid:
katex:
...
![1667964998343](../../assets/JavaWeb(SpringBootVue)/1667964998343.png) 
...
![1668020985363](../../assets/JavaWeb(SpringBootVue)/1668020985363.png) 



第四步：接下来演示外部脚本，注释掉内部脚本，然后在css目录同级创建js目录，然后创建一个名为demo.js的文件：

![1668021080890](../../assets/JavaWeb(SpringBootVue)/1668021080890.png) 
...
![1668021241174](../../assets/JavaWeb(SpringBootVue)/1668021241174.png) 
...
![1668101592422](../../assets/JavaWeb(SpringBootVue)/1668101592422.png) 
...
![1668101718354](../../assets/JavaWeb(SpringBootVue)/1668101718354.png) 
...
![1668101840992](../../assets/JavaWeb(SpringBootVue)/1668101840992.png)
...
![1668101996370](../../assets/JavaWeb(SpringBootVue)/1668101996370.png) 
...
![1668102183766](../../assets/JavaWeb(SpringBootVue)/1668102183766.png) 
...
![1668102256305](../../assets/JavaWeb(SpringBootVue)/1668102256305.png) 
...
![1668102426953](../../assets/JavaWeb(SpringBootVue)/1668102426953.png)

接着我们使用let重复定义变量，代码修改如下：发现idea直接帮我们报错了，说明let声明的变量不能重复定义

![1668102527993](../../assets/JavaWeb(SpringBootVue)/1668102527993.png) 
...
![1668102736759](../../assets/JavaWeb(SpringBootVue)/1668102736759.png) 
...
![1668103531260](../../assets/JavaWeb(SpringBootVue)/1668103531260.png) 
...
![1668584359136](../../assets/JavaWeb(SpringBootVue)/1668584359136.png) 
...
![1668587524509](../../assets/JavaWeb(SpringBootVue)/1668587524509.png)



然后进入到如下界面，点击右侧的参考书

![1668587661914](../../assets/JavaWeb(SpringBootVue)/1668587661914.png) 



然后进入到如下页面，此页面列举出了JavaScript中的所有对象

![1668587855863](../../assets/JavaWeb(SpringBootVue)/1668587855863.png)
...
![1668587953841](../../assets/JavaWeb(SpringBootVue)/1668587953841.png) 

第二类：BOM对象,主要是和浏览器相关的几个对象

![1668588039871](../../assets/JavaWeb(SpringBootVue)/1668588039871.png) 

第三类：DOM对象，JavaScript中将html的每一个标签都封装成一个对象

![1668588141399](../../assets/JavaWeb(SpringBootVue)/1668588141399.png) 
...
![1668590655291](../../assets/JavaWeb(SpringBootVue)/1668590655291.png) 
...
![1668590614787](../../assets/JavaWeb(SpringBootVue)/1668590614787.png) 
...
![1668590895662](../../assets/JavaWeb(SpringBootVue)/1668590895662.png) 
...
- length属性：
  ...
  ![1668591566013](../../assets/JavaWeb(SpringBootVue)/1668591566013.png) 
...
- forEach()函数
  ...
  ![1668592407223](../../assets/JavaWeb(SpringBootVue)/1668592407223.png)  
...
- push()函数
  ...
  ![1668593799333](../../assets/JavaWeb(SpringBootVue)/1668593799333.png) 
...
- splice()函数
  ...
  ![1668594075039](../../assets/JavaWeb(SpringBootVue)/1668594075039.png) 
...
![1668595022160](../../assets/JavaWeb(SpringBootVue)/1668595022160.png) 
...
![1668595450181](../../assets/JavaWeb(SpringBootVue)/1668595450181.png) 
...
![1668596039535](../../assets/JavaWeb(SpringBootVue)/1668596039535.png)
...
![1668596701343](../../assets/JavaWeb(SpringBootVue)/1668596701343.png) 

但是当我们将双引号切换成单引号，再次校验，则报错，如下图所示：

![1668596798551](../../assets/JavaWeb(SpringBootVue)/1668596798551.png)
...
![1668597000013](../../assets/JavaWeb(SpringBootVue)/1668597000013.png) 
...
![1668597176685](../../assets/JavaWeb(SpringBootVue)/1668597176685.png) 
...
![1668597352197](../../assets/JavaWeb(SpringBootVue)/1668597352197.png) 
...
![1668597489911](../../assets/JavaWeb(SpringBootVue)/1668597489911.png) 
...
![1668597624263](../../assets/JavaWeb(SpringBootVue)/1668597624263.png) 
...
![](../../assets/JavaWeb(SpringBootVue)/image-20210815194911914.png) 
...
- alert()函数：弹出警告框，函数的内容就是警告框的内容
  ...
  ![1668794735581](../../assets/JavaWeb(SpringBootVue)/1668794735581.png) 
...
- confirm()函数：弹出确认框，并且提供用户2个按钮，分别是确认和取消。
  ...
  ![1668794898891](../../assets/JavaWeb(SpringBootVue)/1668794898891.png) 
...
- setInterval(fn,毫秒值)：定时器，用于周期性的执行某个功能，并且是**循环执行**。该函数需要传递2个参数：
  ...
  ![1668795435780](../../assets/JavaWeb(SpringBootVue)/1668795435780.png) 
...
![1668796236628](../../assets/JavaWeb(SpringBootVue)/1668796236628.png) 
...
![1668796698067](../../assets/JavaWeb(SpringBootVue)/1668796698067.png) 
...
- document.getElementById()： 根据标签的id属性获取标签对象，id是唯一的，所以获取到是单个标签对象。
  ...
  ![1668798266255](../../assets/JavaWeb(SpringBootVue)/1668798266255.png) 
...
- document.getElementsByTagName() :  根据标签的名字获取标签对象，同名的标签有很多，所以返回值是数组。
  ...
  ![1668799227223](../../assets/JavaWeb(SpringBootVue)/1668799227223.png) 
...
- document.getElementsByName() ：根据标签的name的属性值获取标签对象，name属性值可以重复，所以返回值是一个数组。
  ...
  ![1668799393592](../../assets/JavaWeb(SpringBootVue)/1668799393592.png)  
...
- document.getElementsByClassName() : 根据标签的class属性值获取标签对象，class属性值也可以重复，返回值是数组。
  ...
  ![1668799564602](../../assets/JavaWeb(SpringBootVue)/1668799564602.png) 

- 操作属性

  那么获取到标签了，我们如何操作标签的属性呢？通过查询文档资料，如下图所示：

  ![1668800047162](../../assets/JavaWeb(SpringBootVue)/1668800047162.png) 
  ...
  ![1668800387791](../../assets/JavaWeb(SpringBootVue)/1668800387791.png) 
...
![1668800646200](../../assets/JavaWeb(SpringBootVue)/1668800646200.png) 

#### 1.5.4.2 资料准备

在JS目录下，也就是用于存放html文件的同级创建img文件下，然后将`资料/图片素材`中提供的2张图片拷贝到img文件夹中，最终整体结果如下图所示：

![1668801302139](../../assets/JavaWeb(SpringBootVue)/1668801302139.png) 
...
![1668800839720](../../assets/JavaWeb(SpringBootVue)/1668800839720.png) 
...
![1668801541168](../../assets/JavaWeb(SpringBootVue)/1668801541168.png) 
...
![1668801991368](../../assets/JavaWeb(SpringBootVue)/1668801991368.png) 
...
![1668802645347](../../assets/JavaWeb(SpringBootVue)/1668802645347.png) 
...
![1668802830796](../../assets/JavaWeb(SpringBootVue)/1668802830796.png) 
...
- 方式1：通过html标签中的事件属性进行绑定
  ...
  ![1668804375833](../../assets/JavaWeb(SpringBootVue)/1668804375833.png) 
...
- 方式2：通过DOM中Element元素的事件属性进行绑定
  ...
  ![1668804696373](../../assets/JavaWeb(SpringBootVue)/1668804696373.png) 
...
- onfocus:获取焦点事件，鼠标点击输入框，输入框中光标一闪一闪的，就是输入框获取焦点了
  ...
  ![1668805346551](../../assets/JavaWeb(SpringBootVue)/1668805346551.png) 

- onblur:失去焦点事件，前提是输入框获取焦点的状态下，在输入框之外的地方点击，光标从输入框中消失了，这就是失去焦点。

  ![1668805498416](../../assets/JavaWeb(SpringBootVue)/1668805498416.png) 
...
![1668806049390](../../assets/JavaWeb(SpringBootVue)/1668806049390.png) 
...
![1668806362090](../../assets/JavaWeb(SpringBootVue)/1668806362090.png) 
...
![1668857055058](../../assets/JavaWeb(SpringBootVue)/1668857055058.png) 
...
![1668858213508](../../assets/JavaWeb(SpringBootVue)/1668858213508.png) 
...
![1668858952627](../../assets/JavaWeb(SpringBootVue)/1668858952627.png) 
...
![1668859214102](../../assets/JavaWeb(SpringBootVue)/1668859214102.png) 
...
- v-bind:  为HTML标签绑定属性值，如设置  href , css样式等。当vue对象中的数据模型发生变化时，标签的属性值会随之发生变化。
  ...
  ![1668860425429](../../assets/JavaWeb(SpringBootVue)/1668860425429.png) 
...
- v-model： 在表单元素上创建双向数据绑定。什么是双向？
  ...
  ![1668861009068](../../assets/JavaWeb(SpringBootVue)/1668861009068.png) 
...
![1668864281939](../../assets/JavaWeb(SpringBootVue)/1668864281939.png) 
...
![1668864558419](../../assets/JavaWeb(SpringBootVue)/1668864558419.png) 
...
![1668866805981](../../assets/JavaWeb(SpringBootVue)/1668866805981.png) 
...
- 需求：
  ...
  ![1668868100828](../../assets/JavaWeb(SpringBootVue)/1668868100828.png) 
...
![1668867134683](../../assets/JavaWeb(SpringBootVue)/1668867134683.png)
...
![1668867458156](../../assets/JavaWeb(SpringBootVue)/1668867458156.png) 
